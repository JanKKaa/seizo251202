...
urlpatterns = [
    ...
    path('tablet/', views.tablet_device_list, name='tablet_device_list'),
    path('tablet/select/', views.tablet_select, name='tablet_select'),
    path('tablet/add/', views.tablet_device_edit, name='tablet_device_add'),
    path('tablet/edit/<int:pk>/', views.tablet_device_edit, name='tablet_device_edit'),
    path('tablet/inspection/add/', views.tablet_inspection_add, name='tablet_inspection_add'),
    path('tablet/inspection/confirm/<int:pk>/', views.tablet_inspection_confirm, name='tablet_inspection_confirm'),
    ...
    path('material-stock-ledger/export.csv', views.material_stock_ledger_csv, name='material_stock_ledger_csv'),
    ...
    path('material-inventory/export.csv', views.material_inventory_csv, name='material_inventory_csv'),
    path('material-inventory/adjust/', views.material_inventory_adjust, name='material_inventory_adjust'),
    ...
    path('material-out-stock-ledger/export.csv', views.material_out_stock_ledger_csv, name='material_out_stock_ledger_csv'),
